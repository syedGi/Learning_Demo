...
public class TutorialController {
	...
	/*
	 * @GetMapping("/tutorials") public String getAll(Model model, @Param("keyword")
	 * String keyword) { ...
	 * 
	 * return "tutorials"; }
	 */
	...
	/*
	 * @GetMapping("/tutorials/new") public String addTutorial(Model model) { ...
	 * 
	 * return "tutorial_form"; }
	 * 
	 * @PostMapping("/tutorials/save") public String saveTutorial(Tutorial tutorial,
	...
	/*
	 * @GetMapping("/tutorials/{id}") public String editTutorial(@PathVariable("id")
	...
	/*
	 * @GetMapping("/tutorials/delete/{id}") public String
	 * deleteTutorial(@PathVariable("id") Integer id, Model model,
	 * RedirectAttributes redirectAttributes) { ...
	 * 
	 * return "redirect:/tutorials"; }
	 */
	...
	/*
	 * @GetMapping("/tutorials/{id}/published/{status}") public String
	...
	@GetMapping("/tutorials/new")
	  public String addTutorial(Model model) {
		 ...
		 * "The Tutorial has been saved successfully!"); } catch (Exception e) {
